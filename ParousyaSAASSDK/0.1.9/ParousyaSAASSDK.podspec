...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://github.com/lelinh/Parousya-SAAS-iOS-SDK/releases/download/0.1.9/ParousyaSAASSDK_0.1.9.zip' }
  s.ios.deployment_target = '10.0'
  s.ios.vendored_frameworks = 'ParousyaSAASSDK.xcframework'
